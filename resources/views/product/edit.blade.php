...
<div class="container-fluid">
    ...
    <div class="pull-right">
        <a class="btn btn-primary" href="{{ route('product.index') }}"> Index</a>
    </div>
    <section class="container">
        ...
        <form action="{{route('product.update',['id'=> $data->id])}}" method="POST">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="subcategory" name="subcategory_id">
                    ...
                    @foreach($subcategories as $subcategory)
                        <option value="{{$subcategory->id}}" {{ $subcategory->id == old('subcategory_id', $data->subcategory_id) ? 'selected' : '' }}>{{$subcategory->name}}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="quantity" placeholder="Enter qty" name="quantity" value="{{old('quantity',$data->quantity)}}">
            </div>
